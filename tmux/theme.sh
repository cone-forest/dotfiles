...
onedark_black=$background
onedark_blue=$background
onedark_yellow=$background
onedark_red=$background
onedark_white=$foreground
onedark_green=$background
onedark_visual_grey=$background
onedark_comment_grey=$background
...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]"
